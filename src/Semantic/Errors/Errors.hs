...
data Errors a
  ...
  | EArrayExprListIntitalizerInvalidUse -- ^ Invalid use of an expression list array initializer (E054)
  | EOptionVariantInitializerInvalidUse -- ^ Invalid use of an option variant initializer (E055)
