...
data Error
  ...
  | EFieldValueAssignmentUnknownFields (Identifier, Location) [Identifier] -- ^ Unknown field/s in field assignment expression (SE-120)
  ...
  | EMatchCaseUnknownVariants [Identifier] -- ^ Unknown variant/s in match case (SE-148)
  | EMatchMissingCases [Identifier] -- ^ Missing case/s in match statement (SE-149)
  | EIsVariantInvalidType TerminaType -- ^ Invalid type for is variant expression (SE-150)
  | EIsOptionVariantInvalidType TerminaType -- ^ Invalid type for is option variant expression (SE-151)
  | EIsVariantEnumTypeMismatch Identifier Identifier -- ^ Enum type mismatch in is variant expression (SE-152)
  | EOutputPortInvalidProcedure Identifier -- ^ Invalid procedure in output port (SE-153)
  | EInvalidPoolInitialization -- ^ Invalid pool initialization (SE-154)
  | EInvalidAtomicInitialization -- ^ Invalid atomic initialization (SE-155)
  | EInvalidAtomicArrayInitialization -- ^ Invalid atomic array initialization (SE-156)
  | EInvalidMsgQueueInitialization -- ^ Invalid message queue initialization (SE-157)
  | EUnknownGlobal Identifier -- ^ Unknown global object (SE-158)
  | EInvalidInterruptEmitterType TerminaType -- ^ Invalid interrupt emitter type (SE-159)
  | EInvalidPeriodicTimerEmitterType TerminaType -- ^ Invalid periodic timer emitter type (SE-160)
  | EInvalidSystemInitEmitterType TerminaType -- ^ Invalid system init emitter type (SE-161)
  | EInboundPortConnectionMsgQueueTypeMismatch Identifier TerminaType TerminaType -- ^ Message queue type mismatch in inbound port connection (SE-162)
  | EOutboundPortConnectionMsgQueueTypeMismatch Identifier TerminaType TerminaType -- ^ Message queue type mismatch in outbound port connection (SE-163)
  | EAllocatorPortConnectionPoolTypeMismatch Identifier TerminaType TerminaType -- ^ Pool type mismatch in allocator port connection (SE-164)
  deriving Show
