...
data Error
  ...
  | EFieldMissing (Identifier, Location) [Identifier] -- ^ Missing field/s in field assignment expression (SE-119)
  | EFieldExtra (Identifier, Location) [Identifier] -- ^ Extra field/s in field assignment expression (SE-120)
  ...
  | EMemberFunctionAccessInvalidType TerminaType -- ^ Invalid member function access type (SE-126)
  | EMemberAccessUnknownField (Identifier, Location) Identifier -- ^ Unknown field in member access (SE-127)
  | EMemberAccessInvalidProcedureCall Identifier -- ^ Invalid procedure call inside member function (SE-128)
