...
data Error
  ...
  | EAtomicUninitialized -- ^ Uninitialized atomic object (SE-156)
  | EAtomicArrayUninitialized -- ^ Uninitialized atomic array object (SE-157)
  | EInvalidMsgQueueInitialization -- ^ Invalid message queue initialization (SE-158)
  | EUnknownGlobal Identifier -- ^ Unknown global object (SE-159)
  | EInvalidInterruptEmitterType TerminaType -- ^ Invalid interrupt emitter type (SE-160)
  | EInvalidPeriodicTimerEmitterType TerminaType -- ^ Invalid periodic timer emitter type (SE-161)
  | EInvalidSystemInitEmitterType TerminaType -- ^ Invalid system init emitter type (SE-162)
  | EInboundPortConnectionMsgQueueTypeMismatch Identifier TerminaType TerminaType -- ^ Message queue type mismatch in inbound port connection (SE-163)
  | EOutboundPortConnectionMsgQueueTypeMismatch Identifier TerminaType TerminaType -- ^ Message queue type mismatch in outbound port connection (SE-164)
  | EAllocatorPortConnectionPoolTypeMismatch Identifier TerminaType TerminaType -- ^ Pool type mismatch in allocator port connection (SE-165)
  deriving Show
