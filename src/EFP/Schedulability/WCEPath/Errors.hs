...
instance ErrorMessage WCEPathErrors where
    ...
    errorIdent (AnnotatedError (EUnknownClass _id) _pos) = "WCEPE-001"
    errorIdent (AnnotatedError (EUnknownMemberFunction _id _clsId) _pos) = "WCEPE-002"
    errorIdent (AnnotatedError (EDuplicatedPathName _pathName (_classId, _functionId, _prevPos)) _pos) = "WCEPE-003"
