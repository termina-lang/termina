...
instance ErrorMessage ConstFoldError where
    ...
    errorIdent (AnnotatedError (EStringInitializerInvalidSize _expectedSize _initializerSize) _pos) = "CPE-003"
    errorIdent (AnnotatedError (EConstIntegerOverflow _value _ty) _pos) = "CPE-004"
    errorIdent (AnnotatedError (EConstIntegerUnderflow _value _ty) _pos) = "CPE-005"
    errorIdent (AnnotatedError EConstDivisionByZero _pos) = "CPE-006"
    errorIdent (AnnotatedError (EConstCondition _const) _pos) = "CPE-007"
    errorIdent (AnnotatedError EForLoopStatementZeroIterations _pos) = "CPE-008"
    errorIdent (AnnotatedError (EForLoopStatementNegativeIterations _start _end) _pos) = "CPE-009"
    errorIdent (AnnotatedError (EArraySliceOutOfBounds _size _upperIndex) _pos) = "CPE-010"
    errorIdent (AnnotatedError (EArraySliceNegativeRange _lowerIndex _upperIndex) _pos) = "CPE-011"
    errorIdent (AnnotatedError (EArraySliceInvalidRange _size _lowerIndex _upperIndex) _pos) = "CPE-012"
