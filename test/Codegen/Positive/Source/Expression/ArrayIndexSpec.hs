module Codegen.Positive.Source.Expression.ArrayIndexSpec (spec) where
...
test0 = "function array_test0() {\n" ++
        ...
        "    var array1 : [[i64; 2]; 1] = [[0; 2 : usize]; 1];\n" ++
    ...
    it "Generates array index expressions with the bounds helper" $ do
      renderSource test0 `shouldBe`
        pack ("\n" ++
              ...
              "    size_t foo = 0U;\n" ++
              "\n" ++
              "    uint32_t array0[10U] = { 0U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 0U };\n" ++
              "\n" ++
              "    int64_t array1[1U][2U] = { { INT64_C(0), INT64_C(0) } };\n" ++
              "\n" ++
              "    array0[3U] = 10U;\n" ++
              "\n" ++
